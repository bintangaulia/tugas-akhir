      ...
      <div class="flex gap-10 w-full">
        ...
        <div class="flex items-center justify-between w-full lg:w-auto">
          ...
          <a href="{{ route('landing') }}">
            <div class="flex items-center gap-2">
              ...
              <p class="text-lg lg:text-xl font-bold">Konten Edukasi</p>
            </div>
          </a>
        ...
        <div id="menu"
          ...
          <ul
            ...
            <li><a href="{{ route('news.category', $category->slug) }}" class="{{ request()->is($category->slug) }} hover:text-primary">{{ $category->title }}</a></li>
