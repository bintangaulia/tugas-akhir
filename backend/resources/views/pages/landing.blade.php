    ...
    <div class="flex flex-col px-14 mt-10 ">
      <div class="flex flex-col md:flex-row justify-between items-center w-full mb-6">
        <div class="font-bold text-2xl text-center md:text-left">
          <p>Konten Unggulan Untuk Kamu</p>
        </div>
      ...
      <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
        @foreach ($featureds as $featured)
          ...
          <div
            ...
            <img src="{{ asset('storage/' . $featured->thumbnail) }}" alt="" class="w-full rounded-xl mb-3" style="height:175px; object-fit; cover;">
      ...
      <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div
          ...
          <a href="{{ route('news.show','$news[0->slug]') }}">
            ...
            <img src="{{ asset('storage/' . $news[0]->thumbnail) }}" alt="konten1" class="rounded-2xl">
        ...
        @foreach ($news->skip(1) as $new)
          ...
          <img src="{{ asset('storage/' . $new->thumbnail) }}" alt="konten2" class="rounded-xl md:max-h-48" style="width: 250px; object-fit; cover;">
      ...
      <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
        @foreach ($news as $choice)
          ...
          <div
            ...
            <img src="{{ asset('storage/' . $choice->thumbnail) }}" alt="" class="w-full rounded-xl mb-3" style="height:175px; object-fit; cover;">
